...
public interface ISalesOrder {
    ...
    List<SalesOrderResponse> findByInvoice_NumberContainingIgnoreCase(String invoiceNumber);
    ...
    List<SalesOrderResponse> findByInvoice_CreatedBy_FirstNameLikeIgnoreCaseAndLastNameLikeIgnoreCase(String firstName,String lastName);
}
