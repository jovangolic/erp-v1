...
public class ShiftService implements IShiftService {
	...
	public Shift save(ShiftRequest request) {
		User supervisor = userRepository.findById(request.shiftSupervisorId()).orElseThrow(() -> new SupervisorNotFoundException("Supervisor not found"));
	...
	public Shift update(Long id, ShiftRequest request) {
		Shift shift = shiftRepository.findById(id).orElseThrow(() -> new NoSuchShiftErrorException("Shift not found with id: " + id));
		User supervisor = userRepository.findById(request.shiftSupervisorId()).orElseThrow(() -> new SupervisorNotFoundException("Supervisor not found"));
