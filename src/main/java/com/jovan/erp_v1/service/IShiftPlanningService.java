...
public interface IShiftPlanningService {
    ...
    List<ShiftPlanningResponse> findByWorkCenter_CapacityGreaterThan(BigDecimal capacity);
    List<ShiftPlanningResponse> findByWorkCenter_CapacityLessThan(BigDecimal capacity);
}
