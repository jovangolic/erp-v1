...
public interface IMaterialService {
    ...
    //nove metode
    List<MaterialResponse> findByReorderLevelGreaterThan(BigDecimal reorderLevel);
    List<MaterialResponse> findByReorderLevelLessThan(BigDecimal reorderLevel);
    List<MaterialResponse> findByStorage_LocationContainingIgnoreCase(String storageLocation);
    List<MaterialResponse> findByStorage_CapacityGreaterThan(BigDecimal capacity);
    List<MaterialResponse> findByStorage_CapacityLessThan(BigDecimal capacity);
    List<MaterialResponse> findByStorage_Status(StorageStatus status);
