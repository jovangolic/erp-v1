...
public interface IMaterialTransactionService {
        ...
        List<MaterialTransactionResponse> findByMaterial_ReorderLevelGreaterThan(BigDecimal reorderLevel);
        List<MaterialTransactionResponse> findByMaterial_ReorderLevelLessThan(BigDecimal reorderLevel);
