...
public class InventoryResponse {
	...
	public InventoryResponse(Inventory inventory) {
        ...
        this.storageEmployeeName = inventory.getStorageEmployee().getFirstName() + " " + inventory.getStorageEmployee().getLastName();
        this.storageForemanName = inventory.getStorageForeman().getFirstName() + " " + inventory.getStorageForeman().getLastName();
        ...
        this.inventoryItems = inventory.getInventoryItems().stream()
                .map(item -> new InventoryItemsResponse(item))
