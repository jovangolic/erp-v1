...
public interface SalesOrderRepository extends JpaRepository<SalesOrder, Long> {
    ...
    List<SalesOrder> findByInvoice_NumberContainingIgnoreCase(String invoiceNumber);
    ...
    List<SalesOrder> findByInvoice_Payment_ReferenceNumberLikeIgnoreCase(@Param("referenceNumber") String referenceNumber);
    ...
    List<SalesOrder> findByInvoice_Payment_PaymentDateBetween(@Param("startDate") LocalDateTime startDate,@Param("endDate") LocalDateTime endDate);
