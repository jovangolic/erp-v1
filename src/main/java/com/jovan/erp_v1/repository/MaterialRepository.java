...
public interface MaterialRepository extends JpaRepository<Material, Long>, JpaSpecificationExecutor<Material> {
    ...
    //nove metode
    List<Material> findByReorderLevelGreaterThan(BigDecimal reorderLevel);
    List<Material> findByReorderLevelLessThan(BigDecimal reorderLevel);
    List<Material> findByStorage_LocationContainingIgnoreCase(String storageLocation);
    List<Material> findByStorage_CapacityGreaterThan(BigDecimal capacity);
    List<Material> findByStorage_CapacityLessThan(BigDecimal capacity);
    List<Material> findByStorage_Status(StorageStatus status);
