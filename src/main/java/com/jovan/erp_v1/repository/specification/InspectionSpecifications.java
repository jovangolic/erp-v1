...
public class InspectionSpecifications {
	...
	public static Specification<Inspection> fromRequest(InspectionSearchRequest req){
		return Specification.where(hasId(req.id()))
				...
				.and(hasBatchProdDateRange(req.productionDateBefore(), req.productionDateAfter()))
				...
				.and(hasBatchExpDateRange(req.expiryDateBefore(), req.expiryDateAfter()))
				...
				.and(hasLocDateRange(req.locDateBefore(), req.locDateAfter()))
