...
public class InvoiceSpecification {
	...
	public static Specification<Invoice> fromRequest(InvoiceSearchRequest req){
		return Specification.where(hasId(req.id()))
				...
				.and(hasCreatedAtRange(req.createdAtBefore(), req.createdAtAfter()))
				...
				.and(hasPaymentDateRange(req.paymentDateBefore(), req.paymentDateAfter()))
				...
				.and(hasOrderDateRange(req.orderDateBefore(), req.orderDateAfter()))
