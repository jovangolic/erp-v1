...
public class TrackingInfoController {
    ...
    public ResponseEntity<List<TrackingInfoResponse>> findByTrackingNumberAndCurrentLocation(@RequestParam("trackingNumber") String trackingNumber,@RequestParam("currentLocation") String currentLocation){
