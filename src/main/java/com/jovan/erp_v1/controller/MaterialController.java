...
public class MaterialController {
    ...
    @PreAuthorize(RoleGroups.MATERIAL_READ_ACCESS)
    @GetMapping("/by-storage-capacity")
    ...
    @PreAuthorize(RoleGroups.MATERIAL_READ_ACCESS)
    @GetMapping("/reorder-level-greater-than")
    ...
    @PreAuthorize(RoleGroups.MATERIAL_READ_ACCESS)
    @GetMapping("/reorder-level-less-than")
