...
@PreAuthorize("hasAnyRole('ADMIN','SUPERADMIN','PRODUCTION_PLANNER','STORAGE_EMPLOYEE')")
public class MaterialTransactionController {
	...
	@PreAuthorize("hasAnyRole('ADMIN','SUPERADMIN','PRODUCTION_PLANNER','STORAGE_EMPLOYEE','QUALITY_MANAGER')")
