...
public class ShipmentController {
    ...
    public ResponseEntity<List<ShipmentResponse>> findByOutboundDelivery_StatusAndOutboundDelivery_DeliveryDateBetween(@RequestParam("status") DeliveryStatus status, @RequestParam("from") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
            @RequestParam("to") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to){
    ...
    public ResponseEntity<List<ShipmentResponse>> findByOriginStorageIdAndTrackingInfo_EstimatedDeliveryBetween(@PathVariable Long storageId, @RequestParam("from") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate from,
            @RequestParam("to") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate to){
