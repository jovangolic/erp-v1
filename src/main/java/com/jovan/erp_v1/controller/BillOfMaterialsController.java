...
public class BillOfMaterialsController {
    ...
    public ResponseEntity<List<BillOfMaterialsResponse>> findByParentProductIdAndQuantityGreaterThan(@RequestParam("parentProductId") Long parentProductId,@RequestParam("quantity") BigDecimal quantity){
    ...
    public ResponseEntity<List<BillOfMaterialsResponse>> findByParentProductIdAndQuantityLessThan(@RequestParam("parentProductId") Long parentProductId,@RequestParam("quantity") BigDecimal quantity){
    ...
    public ResponseEntity<Boolean> existsByParentProductIdAndComponentId(@RequestParam("parentProductId") Long parentProductId,@RequestParam("componentId") Long componentId){
