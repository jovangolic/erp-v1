...
public class BatchController {
    ...
    public List<BatchResponse> getUpcomingBatches(@PathVariable int daysAhead) {
        return batchService.getUpcomingBatches(daysAhead);
    }

    @GetMapping("/produced-between")
    public List<BatchResponse> getBatchesProducedBetween(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate start,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate end) {
        return batchService.getBatchesProducedBetween(start, end);
    }

    @GetMapping("/expiring-between")
    public List<BatchResponse> getBatchesExpiringBetween(
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate start,
            @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate end) {
        return batchService.getBatchesExpiringBetween(start, end);
    }
