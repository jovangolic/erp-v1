...
@PreAuthorize(RoleGroups.VENDOR_READ_ACCESS)
public class VendorController {

	private final IVendorService vendorService;

	@PreAuthorize(RoleGroups.VENDOR_FULL_ACCESS)
	...
	public ResponseEntity<List<VendorResponse>> findByNameIgnoreCaseContainingAndAddressIgnoreCaseContaining(@RequestParam("name") String name,
