...
@PreAuthorize(RoleGroups.TEST_MEASUREMENT_READ_ACCESS)
public class TestMeasurementController {

	private final ITestMeasurementService testMeasurementService;
	
	@PreAuthorize(RoleGroups.TEST_MEASUREMENT_FULL_ACCESS)
	...
	public ResponseEntity<List<TestMeasurementResponse>> findByInspection_QualityCheck_LocDateAfter(@RequestParam("date") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime date){
