...
public class ShiftController {
	...
	public ResponseEntity<List<ShiftResponse>> findByShiftSupervisorIdAndStartTimeBetween(@PathVariable Long supervisorId, @RequestParam("start") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime start,
			@RequestParam("end") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime end){
	...
	public ResponseEntity<List<ShiftResponse>> findByShiftSupervisor_FirstNameLikeIgnoreCaseAndLastNameLikeIgnoreCase(@RequestParam("firstName") String firstName, @RequestParam("lastName") String lastName){
