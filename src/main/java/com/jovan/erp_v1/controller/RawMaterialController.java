...
public class RawMaterialController {
	...
	public ResponseEntity<List<RawMaterialResponse>> filterRawMaterials(
	  ...
	  List<RawMaterial> materials = rawMaterialService.filterRawMaterials(shelfId, minQty, maxQty, productId);
	...
	public ResponseEntity<List<RawMaterialResponse>> findByCurrentQuantity(@RequestParam("currentQuantity") BigDecimal currentQuantity){
	...
	public ResponseEntity<List<RawMaterialResponse>> findByCurrentQuantityLessThan(@RequestParam("currentQuantity") BigDecimal currentQuantity){
	...
	public ResponseEntity<List<RawMaterialResponse>> findByCurrentQuantityGreaterThan(@RequestParam("currentQuantity") BigDecimal currentQuantity){
	...
	public ResponseEntity<List<RawMaterialResponse>> findByProduct_CurrentQuantity(@RequestParam("currentQuantity") BigDecimal currentQuantity){
	...
	public ResponseEntity<List<RawMaterialResponse>> findByProduct_CurrentQuantityGreaterThan(@RequestParam("currentQuantity") BigDecimal currentQuantity){
		List<RawMaterialResponse> responses = rawMaterialService.findByProduct_CurrentQuantityGreaterThan(currentQuantity);
		return ResponseEntity.ok(responses);
	}
	
	@GetMapping("/product/current-quantity-less-than")
	public ResponseEntity<List<RawMaterialResponse>> findByProduct_CurrentQuantityLessThan(@RequestParam("currentQuantity") BigDecimal currentQuantity){
	...
	public ResponseEntity<List<RawMaterialResponse>> findByShelfAndQuantityGreaterThan(@PathVariable Long shelfId,@RequestParam("quantity") BigDecimal quantity){
	...
	public ResponseEntity<List<RawMaterialResponse>> findByShelfAndQuantityLessThan(@PathVariable Long shelfId,@RequestParam("quantity") BigDecimal quantity){
	...
	public ResponseEntity<List<RawMaterialResponse>>  findByShelfAndExactQuantity(@PathVariable Long shelfId,@RequestParam("quantity") BigDecimal quantity){
	...
	public ResponseEntity<List<RawMaterialResponse>> findByShelf_IdAndCurrentQuantityGreaterThan(@PathVariable Long shelfId,@RequestParam("quantity") BigDecimal quantity){
		List<RawMaterialResponse> responses = rawMaterialService.findByShelf_IdAndCurrentQuantityGreaterThan(shelfId, quantity);
		return ResponseEntity.ok(responses);
	}
	
	@GetMapping("/shelf/{shelfId}/current-quantity-less-than")
	public ResponseEntity<List<RawMaterialResponse>> findByShelf_IdAndCurrentQuantityLessThan(@PathVariable Long shelfId,@RequestParam("quantity") BigDecimal quantity){
		List<RawMaterialResponse> responses = rawMaterialService.findByShelf_IdAndCurrentQuantityLessThan(shelfId, quantity);
		return ResponseEntity.ok(responses);
	}
	
	@GetMapping("/supplierType")
	public ResponseEntity<List<RawMaterialResponse>> findBySupplierType(@RequestParam("supplierType") SupplierType supplierType){
		List<RawMaterialResponse> responses = rawMaterialService.findBySupplierType(supplierType);
		return ResponseEntity.ok(responses);
	}
	
	@GetMapping("/storageType")
	public ResponseEntity<List<RawMaterialResponse>> findByStorageType(@RequestParam("storageType") StorageType storageType){
	...
	public ResponseEntity<List<RawMaterialResponse>> findByUnitMeasure(@RequestParam("unitMeasure") UnitMeasure unitMeasure){
