...
public class SupplyController {
	...
	public ResponseEntity<SupplyResponse> updateSupply(@PathVariable Long id, @Valid @RequestBody SupplyRequest request){
	...
	public ResponseEntity<List<SupplyResponse>> getByStorage(@RequestParam("storageId") Long storageId){
		Storage storage = storageRepository.findById(storageId).orElseThrow(() -> new StorageNotFoundException("Storage not found with id: "+storageId));
	...
	public ResponseEntity<List<SupplyResponse>> getBySuppliesWithMinQuantity(@RequestParam("minQuantity") Integer minQuantity){
