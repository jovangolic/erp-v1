...
@PreAuthorize(RoleGroups.STOCK_TRANSFER_ITEM_READ_ACCESS)
public class StockTransferItemController {

    private final IStockTransferItemService stockTransferItemService;

    @PreAuthorize(RoleGroups.STOCK_TRANSFER_ITEM_FULL_ACCESS)
    ...
    public ResponseEntity<List<StockTransferItemResponse>> findByProduct_Shelf_RowCountBetween(@RequestParam("minRowCount") Integer minRowCount,
    		@RequestParam("maxRowCount") Integer maxRowCount){
    ...
    public ResponseEntity<List<StockTransferItemResponse>> findByProduct_Shelf_ColsBetween(@RequestParam("minCols") Integer minCols,
    		@RequestParam("maxCols") Integer maxCols){
